...
var scrolltotop={
	...
	controlHTML: '<img src="http://blueskyblacksheep.com/wp-content/themes/mirza/images/scroll.png" style="filter:alpha(opacity=70); -moz-opacity:0.7; width:67px; height:67px" id="mirza-scroll" />', //HTML for control, which is auto wrapped in DIV w/ ID="topcontrol"
	...
	init:function(){
		jQuery(document).ready(function($){
			...
			mainobj.$control=$('<div id="topcontrol" style="z-index:2000;">'+mainobj.controlHTML+'</div>')
